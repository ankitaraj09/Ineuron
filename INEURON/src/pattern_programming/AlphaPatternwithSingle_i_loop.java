...
// alphabet pattern with one i loop and various j loops for diff alphabets......and to give space between  we use S.O.P("   ")

public class AlphaPatternwithSingle_i_loop {
